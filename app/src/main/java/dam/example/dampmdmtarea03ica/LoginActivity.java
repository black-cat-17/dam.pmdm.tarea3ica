        ...
        mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>()
        {
            ...
            public void onComplete(@NonNull Task<AuthResult> task)
            {
                if (task.isSuccessful())
                {
                    ...
                    Toast.makeText(getApplicationContext(), "Accediste con exito.", Toast.LENGTH_LONG).show();
                    // Si el inicio de sesión es exitoso, abre la actividad principal
                    Intent intent = new Intent(LoginActivity.this, MainActivity.class);
                    startActivity(intent);
                    finish();  // Para evitar que el usuario regrese a la pantalla de login con el botón "Atrás"
